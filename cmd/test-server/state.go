...
type State struct {
	...
	// RemoveAccountFromGroup only removes this added membership, leaving seed-time memberships
	// intact so the account remains in the c1z after the revoke cycle and a second grant cycle
